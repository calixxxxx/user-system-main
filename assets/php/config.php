...
class Database{
	...
	const USERNAME = 'clintjeremy97@gmail.com';
	const PASSWORD = 'craigaustinbare';
	...
	public function timeInAgo($timestamp){
		...
		switch ($time){
			...
			case $time >= 60 && $time < 3600:
				return (round($time/60) == 1)? ' minute ago' : round($time/60).' minutes ago ';
